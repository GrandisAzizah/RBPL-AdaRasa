...
WHERE p.metode_pengantaran = 'Kurir Catering'
...
<head>
    ...
    <title>Page Notifikasi Tim Dapur</title>
...
<body>
    <div class="container-main">
        <h3 class="mt-4 mb-4">Notifikasi</h3>
        <div class="card" style="max-width: 540px; outline: 1px solid black; position: relative;">
            <div class="row g-0">
                ...
                <div class="col mb-5">
                    <div class="card-body">
                        ...
                        <p class="mb-1">Waktu pesan (hari)</p>
                        <p class="mb-1">Waktu (jam)</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bottom-nav">
        <ul class="nav justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="pengantaranDiterima.php"><svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg">
