...
$pelanggan = query("SELECT * FROM customer ORDER BY nama_pelanggan $sort");
?>
...
<body>
    <div class="container-main">
        <div class="header-nav mt-3">
            ...
            <a href="inputPelanggan.php" class="header-nav-right">
                <svg width="30" height="30" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <?php if (count($pelanggan) == 0) : ?>
            <p class="text-center mt-5" style="color: #979696; margin-top: 20px; height: 70vh; display: flex; align-items: center; justify-content: center;">Belum ada data pelanggan yang ditambahkan</p>
        <?php else : ?>
