...
// Di file pengantaranSelesai.php
// Cukup ini saja, tanpa OR
        ...
        <?php else: ?>
            <?php foreach ($pesanan_per_tanggal as $tanggal => $pesanan_list): ?>
                ...
                <?php foreach ($pesanan_list as $p): ?>
                    <a href="detailPesananDapur.php?id_pesanan=<?= $p['id_pesanan'] ?>" style="text-decoration: none; color: inherit;">
                    ...
                    <div class="dropdown mb-1" style="position: absolute; bottom: 8px; right: 18px;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="updateStatus(<?= $p['id_pesanan'] ?>, 'Diproses')">Diproses</a></li>
                            <li><a class="dropdown-item disabled" href="#" onclick="updateStatus(<?= $p['id_pesanan'] ?>, 'Selesai')">Selesai</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="updateStatus(<?= $p['id_pesanan'] ?>, 'Diantar')">Diantar</a></li>
                        </ul>
                    </div>
    </div>
<?php endforeach; ?>
...
<div class="bottom-nav">
    <ul class="nav justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="#"><svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg">
