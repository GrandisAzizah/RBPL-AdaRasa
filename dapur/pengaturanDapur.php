...
<body>
    <div class="card mb-3" style="max-width: 540px; outline: 1px solid black; position: relative;">
        <div class="row g-0">
            ...
            <div class="col-auto p-3 ms-3">
                <img src="<?= $user['foto_profil_user'] ?>" style="width: 68px; height:68px; object-fit: cover; border-radius: 50%;">
            </div>
    ...
    <div>
        ...
        <div class="menu-item">
            ...
            <span class="label"><a href="gantiUsernameDapur.php">Ganti Username</a></span>
            <a href="gantiUsernameDapur.php">
        ...
        <div class="menu-item">
            ...
            <span class="label"><a href="gantiPasswordDapur.php">Ganti Password</a></span>
            <a href="gantiPasswordDapur.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="24" viewBox="0 0 12 24" fill="none" class="arrow-icon">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1569 12.7111L4.49994 18.3681L3.08594 16.9541L8.03594 12.0041L3.08594 7.05414L4.49994 5.64014L10.1569 11.2971C10.3444 11.4847 10.4497 11.739 10.4497 12.0041C10.4497 12.2693 10.3444 12.5236 10.1569 12.7111Z" fill="black" />
                </svg>
        ...
        <div class="menu-item">
            ...
            <span class="label"><a href="editProfilDapur.php">Edit Profil</a></span>
            <a href="editProfilDapur.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="24" viewBox="0 0 12 24" fill="none" class="arrow-icon">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1569 12.7111L4.49994 18.3681L3.08594 16.9541L8.03594 12.0041L3.08594 7.05414L4.49994 5.64014L10.1569 11.2971C10.3444 11.4847 10.4497 11.739 10.4497 12.0041C10.4497 12.2693 10.3444 12.5236 10.1569 12.7111Z" fill="black" />
                </svg>
        ...
        <div class="menu-item">
            ...
            <span class="label"><a href="tentangAPKDapur.php">Tentang Aplikasi</a></span>
            <a href="tentangAPKDapur.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="24" viewBox="0 0 12 24" fill="none" class="arrow-icon">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1569 12.7111L4.49994 18.3681L3.08594 16.9541L8.03594 12.0041L3.08594 7.05414L4.49994 5.64014L10.1569 11.2971C10.3444 11.4847 10.4497 11.739 10.4497 12.0041C10.4497 12.2693 10.3444 12.5236 10.1569 12.7111Z" fill="black" />
                </svg>
        ...
        <div class="menu-item">
            <a href="kebijakanPrivasiDapur.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="icon">
            ...
            <span class="label"><a href="kebijakanPrivasiDapur.php">Kebijakan Privasi</a></span>
            <a href="kebijakanPrivasiDapur.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="24" viewBox="0 0 12 24" fill="none" class="arrow-icon">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1569 12.7111L4.49994 18.3681L3.08594 16.9541L8.03594 12.0041L3.08594 7.05414L4.49994 5.64014L10.1569 11.2971C10.3444 11.4847 10.4497 11.739 10.4497 12.0041C10.4497 12.2693 10.3444 12.5236 10.1569 12.7111Z" fill="black" />
                </svg>
    ...
    <div class="bottom-nav">
        <ul class="nav justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="pengaturanDapur.php"><svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg">
