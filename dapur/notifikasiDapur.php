        ...
        <?php else: ?>
            <?php foreach ($pesanan_per_tanggal as $tanggal => $pesanan_list): ?>
                <?php foreach ($pesanan_list as $p): ?>
                    <div class="card-notif mb-4">
                        <div class="row g-0">
                            <div class="col">
                                <a href="pesananDapurDiterima.php?id_pesanan=<?= $p['id_pesanan'] ?>" style="text-decoration: none; color: inherit;">
                                    <div class="card-body-notif">
                                        <h5 class="card-title-notif">Ada pesanan baru!</h5>
                                        <p class="mb-1 nama-menu"><?= $p['nama_menu'] ?> (<?= $p['takaran'] ?>)</p>
                                        <?php
                                        ...
                                        ?>
                                        <p class="mb-0 waktu-pesan"><?= $tampil_waktu ?></p>
                                    </div>
                                </a>
                            </div>
                        </div>
